...
주택 임대차 계약과 관련하여 의미가 궁금한 용어를 입력해보세요! 
또는 지금 처한 곤란한 상황에 대해 저에게 알려주세요. 
현재 기준 최신 법령을 기반으로 도움을 드릴게요. (기준일 : 2024. 5. 14.)

해당 챗봇은 아래 5개의 법령을 기반으로 답변을 드리고 있습니다.
- 주택임대차보호법
- 주택임대차보호법 시행령
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        ChatMessage(
            role="assistant", content="안녕!🐌 나는 지금 살고 있는 집이 불안한 달팽이들을 위한 챗봇이야. 임대차 계약과 보증금 반환과 관련하여 궁금한 점을 물어봐! "
        )
    ]
